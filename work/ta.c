...
static TEE_Result delete_object(uint32_t param_types, TEE_Param params[4])
{
	...
	TEE_Result res;
	uint32_t read_bytes;//读取文件的byte数
	char* obj_id;
	size_t obj_id_sz;
	char *data;//接收到的人脸数据
	size_t data_sz;
	char *read_data;//读取到的文件人脸数据
	size_t read_data_sz;
				...
				TEE_Param params[4])
{
	...
	key[0] = '3';key[1] = 'I';key[2] = '8';key[3] = 'T';key[4] = 'i';key[5] = 'Y';key[6] = 'f';key[7] = 'u';
	key[8] = '4';key[9] = 'k';key[10] = 'K';key[11] = 'm';key[12] = 'r';key[13] = 'z';key[14] = '1';key[15] = 'A';
